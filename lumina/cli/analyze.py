...
from lumina.core.performance_stats import PerformanceTracker
from lumina.core.types import Statistics
from lumina.db import CatalogDB as CatalogDatabase
from lumina.shared import format_bytes
...
def analyze(
    ...
    console.print(
        f"\n[bold cyan]Lumina V2 - Analysis[/bold cyan] [dim]v{version_str}[/dim]\n"
    )
        ...
        try:
            with CatalogDatabase(catalog_dir) as db:
                ...
                if existing_catalog:
                    ...
                    from lumina.db.models import Statistics as StatsModel
    ...
    try:
        with CatalogDatabase(catalog_dir) as db:
            ...
            if extract_previews:
                ...
                from lumina.analysis.preview_extractor import PreviewExtractor
